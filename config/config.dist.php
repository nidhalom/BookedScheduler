 ...
 */
$conf['settings']['app.title'] = 'GSM SEAAL';			// application title
...
$conf['settings']['admin.email'] = 'nidhalm01@gmail.com';         // email address of admin user
$conf['settings']['admin.email.name'] = 'The Administrator';	// name to be used in From: field when sending automatic emails
$conf['settings']['company.name'] = 'SEAAL';                         // name of company, if applicable
$conf['settings']['company.url'] = 'https://www.seaal.dz';                          // URL of company, if applicable
...
$conf['settings']['default.language'] = 'fr';                // find your language in the lang directory
$conf['settings']['script.url'] = 'https';   	                    // public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['inactivity.timeout'] = '60';     			// minutes before the user is automatically logged out
...
$conf['settings']['home.url'] = 'pages/SchedulePage.php'; 	      					// the url to open when the logo is clicked
$conf['settings']['logout.url'] = 'pages/logoutPage.php'; 	      					// the url to be directed to after logging out
